  ...
  return (
    <section className="relative min-h-[90vh] overflow-hidden bg-deep-900">
      ...
      <div className="absolute inset-0 overflow-hidden opacity-50">
        <Image
          src="https://images.unsplash.com/photo-1558617320-e695f0d420de?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
